defmodule ThreewirebuildWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ThreewirebuildWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/threewirebuild_web/templates",
                        namespace: ThreewirebuildWeb
